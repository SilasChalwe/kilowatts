...
void testRegisterSelf() {
    ...
    reportCheck("registerSelf() on an unknown MAC returns true",
                registry.registerSelf(CENTRAL_MAC, NodeRole::CENTRAL, "Central", "0.2.0-foundation", "esp32:2core", 500U));
    ...
    reportCheck("registerSelf() a second time for the same MAC is a no-op (returns false)",
                !registry.registerSelf(CENTRAL_MAC, NodeRole::CENTRAL, "Renamed", "0.2.0-foundation", "esp32:2core", 600U));
...
void testPersistenceHonestOnHostBuild() {
    ...
    NodeCommissioningRegistry registry;
    registry.registerSelf(CENTRAL_MAC, NodeRole::CENTRAL, "Central", "0.2.0-foundation", "esp32:2core", 100U);
