 ...
 * pick and save a real SSID/password from a phone, without ever needing
 * KilowattsSecrets.h's compiled-in WIFI_SSID/WIFI_PASSWORD to be correct
 * for a given site. It does not itself manage station connectivity
