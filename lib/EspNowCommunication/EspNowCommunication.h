...
public:
    ...
    MacAddress getUpstreamNodeMacAddress() const;


    bool hasCentralMacAddress() const;


    MacAddress getCentralMacAddress() const;
...
private:
    ...
    std::atomic<std::uint32_t> nextMessageId_;
    ...
    /** Protects discovery candidates and the complete upstream/Central route state. */
